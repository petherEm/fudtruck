...
const CuisineAmerican = ({ american }) => {

    const recipes = american.results;
  


  return (
    <div className="flex flex-col max-w-6xl mx-auto">
      <h1 className="text-6xl font-bold mt-10 mb-8">American cuisine</h1>
      <Splide options={{
          perPage: 4,
          arrows: false,
          pagination: false,
...
export default CuisineAmerican;
